...
`egoengine_mjwp_snapshot_v3_reward_aligned` covers all 342 runtime arrays exposed by
MuJoCo-Warp 3.13 across current/previous Data, Contact, and Constraint storage.
The loader rejects legacy partial or pre-reward-alignment snapshots, a different MuJoCo-Warp version,
