#!/usr/bin/env python3
"""EgoForce B1 inference on the fixed v9 hardest no-seed subset.
...
Run inside the v2s-egoforce environment:
    ...
    conda run -n v2s-egoforce python \
        scripts/run_egoforce_v9_inference.py \
        --out runs/hot3d_hand_diagnosis/hand_backbone_benchmark_v9
"""
...
DEFAULT_OUT = REPO_ROOT / "runs/hot3d_hand_diagnosis/hand_backbone_benchmark_v9"
...
def main() -> int:
    ...
    for row in rows:
        ...
        with tarfile.open(tar_path, "r") as tar:
            ...
            for view, stream_id in (("left", "1201-1"), ("right", "1201-2")):
                ...
                images[view] = cv2.cvtColor(rgb, cv2.COLOR_BGR2RGB)
    ...
    candidates_path = args.out / "egoforce_raw_candidates.csv"
    ...
    selected_path = args.out / "egoforce_selected_predictions.json"
